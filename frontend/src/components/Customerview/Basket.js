    ...
    <>
      ...
      <tr key={item.pro._id}>
        <th className="p-3 pl-0 border-0" scope="row">
          <div className="d-flex align-items-center">
            <a
              ...
              href={`/detail-product/${item.pro._id}`}
            >
              <img
                src={item.pro.Avatar}
                alt="..."
        ...
        <td className="p-3 align-middle border-0">
          ...
          <Icon path={mdiTrashCan} size={1} onClick={() => dispatch(removeFromBasket(item.pro._id))} />
                  ...
                  <div className="row align-items-center">
                    <div className="col-md-6">
                      <ul className="list-inline mb-0">
                        ...
                        {!user?.LastName?
                          <>
                            <Link ><span className="btn btn-primary"><LoginCustomer/></span></Link>
                          </>:null
                        }
                      </ul>
                    </div>
