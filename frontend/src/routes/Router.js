...
import ProfileCustomer from '../components/Customerview/ProfileCustomer.js';
import UpdateProfile from '../components/Customerview/UpdateProfile.js';
  
/* ****Pages***** */
const Dashboard =  (lazy(() => import('../views/admin/Dashboard.js')))
const Category =  (lazy(() => import('../components/Cards/CardsCategories/CardListCategories.js')))
...
const Router = [
  ...
  },
  {
    ...
    children: [ 
      ...
      { path: '/my-profile/', exact: true, element: <ProfileCustomer  /> },
      { path: '/settings-profile/', exact: true, element: <UpdateProfile  /> },
